...
const Third: React.FC = () => {
  ...
  return (
    <div className="bg-gray-900 text-white p-8 py-14 font-sans container mx-auto min-w-full">
      <div className="max-w-screen mx-auto flex flex-col ">
        <div className="mb-8 w-70 text-justify px-10 pb-10" >
          <div className="text-cyan-300 text-3xl mb-4  flex justify-center">
            "We&apos;re able to do a lot of things much faster, much more efficiently. Windows 11 Pro made my whole team very effective."
          </div>
          <div className="text-white">
            <div className="font-bold text-lg">Jeyalakshmi Venkatanarayanan</div>
