        ...
        <div>
            <div className='bg-[#010B1A] flex justify-between p-10 container mx-auto min-w-full'>
                <div className='text-white'>
                    <p>Ingram provides end-to-end supply chain solutions for all categories of <br />Information Technology, Telecom, Lifestyle, Healthcare, and Solar products</p>
                </div>
                <div className='flex space-x-5'>
                    <a href="#" className="flex-shrink-0">
                        <img src="/facebook.svg" alt="Facebook" className="h-10 w-10 rounded-full" />
                    </a>
                    <a href="#" className="flex-shrink-0">
